...
int main(){
    ...
    // Generate BMP visualizations (4 terrain heatmaps + sites map + dashboard)
    // and open them. Uses pure C++ only — no external visualization libraries.
    create_visualizations(
        elevation, illumination, water_ice, signal_occultation,
